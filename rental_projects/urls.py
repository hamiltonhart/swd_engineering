...
urlpatterns = [
    ...
    path("update/<str:abbr>/", views.RentalProjectUpdateView.as_view(), name="rental_projects_update"),
    path("delete/<str:abbr>/", views.RentalProjectDeleteView.as_view(), name="rental_projects_delete"),
